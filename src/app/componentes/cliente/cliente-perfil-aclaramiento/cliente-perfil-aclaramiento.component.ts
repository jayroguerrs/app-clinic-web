...
import {AccionCita, ColorEstadoCita, DocumentoPlantillas, Meses} from "../../../shared/enumeracion/enums";
...
@Component({
  selector: 'app-cliente-perfil-aclaramiento',
  templateUrl: './cliente-perfil-aclaramiento.component.html',
  styleUrls: ['./cliente-perfil-aclaramiento.component.scss']
})
export class ClientePerfilAclaramientoComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.router.navigate(['/ClientePerfil', this.idCliente , 'General'], { queryParams: { idServicio: 2 } });
  }
  ...
  cargarCitasPendientes(): void{
    ...
    this.dtOptionsTableCitasPendientes = {
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.subscriptionCitas = this.citaService.obtenerParaPerfilByServicio(this.idCliente,2).subscribe(
          (resultado: CitaClass[]) => {
  ...
  cargarHistorialSeguimiento(): void{
    ...
    this.subscriptionHistorial = this.citaSeguimientoService.obtenerHistorialSeguimientoPorServicio(this.idCliente, 2).subscribe(
      resultado => {
        // console.log(resultado);
        this.historiales  = resultado;
        //console.log('historiales', resultado);

        this.subscriptionZonasAtendidas = this.clienteService.obtenerTodasZonasAtendidasPorServicio(this.idCliente, 2).subscribe(
          resultado => {
