...
import {
  ...
  AccionCronograma,
  ColorEstadoCita,
  DocumentoPlantillas, EnumServicio,
  Meses
...
@Component({
  selector: 'app-cliente-perfil-dermatologia',
  templateUrl: './cliente-perfil-dermatologia.component.html',
  styleUrls: ['./cliente-perfil-dermatologia.component.scss']
})
export class ClientePerfilDermatologiaComponent implements OnInit, OnDestroy {
  ...
  documentoSelected: DocumentoCLiente | null = null;
  ...
  cabeceraPagina: string | null = null;
  piePagina: string | null = null;
  ...
  cargarCitasPendientes(): void{
    ...
    this.dtOptionsTableCitasPendientes = {
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.subscriptionCitas = this.citaService.obtenerParaPerfilByServicio(this.idCliente, EnumServicio.Dermatologia).subscribe(
          (resultado: CitaClass[]) => {
      ...
      columns: [
        ...
        //     const url = this.route.createUrlTree(['Corporal360/Cronograma',data,AccionCronograma.ASIGNARCITAS, this.idCliente]);
