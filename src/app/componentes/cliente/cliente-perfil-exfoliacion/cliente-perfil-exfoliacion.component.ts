...
@Component({
  selector: 'app-cliente-perfil-exfoliacion',
  templateUrl: './cliente-perfil-exfoliacion.component.html',
  styleUrls: ['./cliente-perfil-exfoliacion.component.scss']
})
export class ClientePerfilExfoliacionComponent implements OnInit, OnDestroy {
  ...
  cargarCitasPendientes(): void{
    ...
    this.dtOptionsTableCitasPendientes = {
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.subscriptionCitas = this.citaService.obtenerParaPerfilByServicio(this.idCliente, EnumServicio.Exfoliacion).subscribe(
          (resultado: CitaClass[]) => {
