...
@Component({
  selector: 'app-cliente-perfil-tratamiento-facial',
  templateUrl: './cliente-perfil-tratamiento-facial.component.html',
  styleUrls: ['./cliente-perfil-tratamiento-facial.component.scss']
})
export class ClientePerfilTratamientoFacialComponent implements OnInit, OnDestroy {
  ...
  cargarCitasPendientes(): void{
    ...
    this.dtOptionsTableCitasPendientes = {
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.subscriptionCitas = this.citaService.obtenerParaPerfilByServicio(this.idCliente, EnumServicio.TratamientoFacial).subscribe(
          (resultado: CitaClass[]) => {
