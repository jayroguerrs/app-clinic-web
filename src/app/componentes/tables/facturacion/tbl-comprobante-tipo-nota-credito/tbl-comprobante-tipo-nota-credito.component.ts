...
@Component({
  selector: 'tbl-comprobante-tipo-nota-credito',
  templateUrl: './tbl-comprobante-tipo-nota-credito.component.html',
  styleUrls: ['./tbl-comprobante-tipo-nota-credito.component.scss']
})
export class TblComprobanteTipoNotaCreditoComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  selected = new Subject<ComprobanteTipoNotaCredito | null>();
  dataTable: any;
  ...
  initValues(): void{
    this.optionDataTable = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.subscription = this.api.listar( this.auth.getUser().id ).subscribe((data: ComprobanteTipoNotaCredito[]) => {
