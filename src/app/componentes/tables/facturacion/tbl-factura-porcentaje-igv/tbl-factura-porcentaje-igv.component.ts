...
@Component({
  selector: 'tbl-factura-porcentaje-igv',
  templateUrl: './tbl-factura-porcentaje-igv.component.html',
  styleUrls: ['./tbl-factura-porcentaje-igv.component.scss']
})
export class TblFacturaPorcentajeIgvComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  selected = new Subject<FacturaPorcentajeIgv | null>();
  dataTable: any;
  ...
  initValues(): void{
    this.optionDataTable = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.subscription = this.api.listar( this.auth.getUser().id ).subscribe((data: FacturaPorcentajeIgv[]) => {
      ...
      columns: [
        ...
        { title: 'Valor', data: 'valor', render: (data: number) => {
