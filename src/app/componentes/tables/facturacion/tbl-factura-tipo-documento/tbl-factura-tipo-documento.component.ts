...
@Component({
  selector: 'tbl-factura-tipo-documento',
  templateUrl: './tbl-factura-tipo-documento.component.html',
  styleUrls: ['./tbl-factura-tipo-documento.component.scss']
})
export class TblFacturaTipoDocumentoComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  selected = new Subject<FacturaTipoDocumento | null>();
  dataTable: any;
  ...
  initValues(): void{
    this.optionDataTable = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.subscription = this.api.listar( this.auth.getUser().id ).subscribe((data: FacturaTipoDocumento[]) => {
