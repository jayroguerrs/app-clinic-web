...
@Component({
  selector: 'tbl-comprobante-serie',
  templateUrl: './tbl-comprobante-serie.component.html',
  styleUrls: ['./tbl-comprobante-serie.component.scss']
})
export class TblComprobanteSerieComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  initValues(): void{
    this.optionDataTable = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.subscription = this.api.listar( this.auth.getUser().id ).subscribe((data: ComprobanteSerie[]) => {
      ...
      columns: [
        ...
        { title: 'N° Actual', data: 'numeroActual', class: 'fw-bold'},
