...
@Component({
    selector: 'app-mdl-tratamiento',
    templateUrl: 'mdl-tratamiento.component.html'
})
export class MdlTratamientoComponent implements OnInit, OnDestroy {

    @Input() data: Tratamiento | null = null;
