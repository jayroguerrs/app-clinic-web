...
import {MdlNuevoItemModule} from "../mdl-nuevo-item/mdl-nuevo-item.module";
import {MdlDatosClienteComprobanteModule} from "../mdl-datos-cliente-comprobante/mdl-datos-cliente-comprobante.module";
import {NgxCurrencyModule} from "ngx-currency";
import {MdlPdfGoogleViewModule} from "../../mdl-pdf-google-view/mdl-pdf-google-view.module";
import {MdlListaDatosClienteComprobanteModule} from "../mdl-lista-datos-cliente-comprobante/mdl-lista-datos-cliente-comprobante.module";
...
import {MdlFacturaItemModule} from "../mdl-factura-item/mdl-factura-item.module";
import {MdlEmisionNotaCreditoComponent} from "./mdl-emision-nota-credito.component";
...
@NgModule({
    ...
    declarations: [
        MdlEmisionNotaCreditoComponent
    ],
    exports: [MdlEmisionNotaCreditoComponent],
    providers: [],
    bootstrap: [MdlEmisionNotaCreditoComponent]
})
export class MdlEmisionNotaCreditoModule { }
