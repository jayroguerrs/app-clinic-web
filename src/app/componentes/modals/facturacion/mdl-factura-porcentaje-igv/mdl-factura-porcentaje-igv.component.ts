...
@Component({
    selector: 'app-mdl-factura-porcentaje-igv',
    templateUrl: 'mdl-factura-porcentaje-igv.component.html'
})
export class MdlFacturaPorcentajeIgvComponent implements OnInit, OnDestroy {

    @Input() data: FacturaPorcentajeIgv | null = null;
    ...
    constructor(
        ...
        private api: FacturaPorcentajeIgvService,
    ...
    get model(): any {
        return {
            ...
            valor: parseFloat(this.f.valor.value),
    ...
    onSubmit(): void {
        ...
        if (this.data ){
            // EDITAR
          Swal.fire({
            html: `Desea editar los datos del porcentaje de igv <b>${this.data?.nombre}</b>??`,
            icon: 'question',
              ...
              if(result.isConfirmed) {
                ...
                this.api.modificar(this.model).subscribe((res: boolean | ErrorSistema)=> {
                    ...
                    if (res instanceof ErrorSistema){
                      ...
                      Swal.fire({
                        html: `Se modifico los datos del porcentaje de igv!!!`,
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: 'Aceptar',
                        customClass: {
                  ...
                  error => {
                    Swal.fire({
                      title: 'Error',
                      html: `Error al intentar modificar los datos del porcentaje de igv`,
                      icon: 'error',
                      buttonsStyling: false,
                      confirmButtonText: 'Aceptar',
                      customClass: {
                    ...
                    console.log('Error al modificar el porcentaje de igv', error);
                    this.loading = false;
                  });
              }else{
                this.cerrarModal();
            ...
            // NUEVO
          Swal.fire({
            title: 'Desea registrar el nuevo porcentaje de igv??',
            icon: 'question',
            allowOutsideClick: false,
            allowEscapeKey: false,
            buttonsStyling: false,
              ...
              if(result.isConfirmed) {
                ...
                this.api.registrar(this.model).subscribe((res: boolean | ErrorSistema) => {
                    if (res instanceof ErrorSistema){
                      ...
                      Swal.fire({
                        text: "Se registro el porcentaje de igv con exito",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: 'Aceptar',
                        customClass: {
                  ...
                  error => {
                    this.loading = false;
                    console.log('Error al registrar el porcentaje de igv', error);
                    Swal.fire({
                      title: 'Error',
                      text: 'Error al registrar el porcentaje de igv',
                      icon: 'error',
                      buttonsStyling: false,
                      confirmButtonText: 'Aceptar',
                      customClass: {
