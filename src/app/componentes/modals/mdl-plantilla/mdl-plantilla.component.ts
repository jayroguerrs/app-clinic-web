...
import { Plantilla } from 'src/app/shared/models/plantilla';

@Component({
    selector: 'app-mdl-plantilla',
    templateUrl: 'mdl-plantilla.component.html'
})
export class MdlPlantillaComponent implements OnInit, OnDestroy {

    @Input() data: Plantilla | null = null;
