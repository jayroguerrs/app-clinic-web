...
export class CitasAgendadasComponent implements OnInit, AfterViewInit, OnDestroy {
...
/*
  ...
  buildGraph(): void{
    ...
    am4core.ready(() => {
      ...
      setTimeout( () => {
        ...
        this.chart = am4core.create("chartCitasAgendadasTotal", am4charts.XYChart);
  ...
  buildPieGraph(): void{
    ...
    am4core.ready(() => {
      ...
      // Create chart instance
      this.piechart = am4core.create("chartCitasAgendadas", am4charts.PieChart);
  ...
  getExportFileName(): string{
    return `Citas agendadas por sede desde ${this.FechaInicio} hasta ${this.FechaFin} (Genero - ${this.Genero})`;
  }
