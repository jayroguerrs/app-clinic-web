...
import {TblCitaReporteDetalladoComponent} from "./tbl-cita-reporte-detallado/tbl-cita-reporte-detallado.component";
...
@Component({
  templateUrl: 'cita-reporte-detallado.component.html' ,
  styleUrls: ['./cita-reporte-detallado.component.scss'],
  providers: [DatePipe],
  animations: [
    trigger('collapse', [
...
export class CitaReporteDetalladoComponent implements OnInit, OnDestroy, AfterViewInit{
    ...
    collectionData: CitaReporteDetallado[] = [];
    submitted = false;

    // Spinner
    rutaImageSpinner = '<img src="assets/images/logo-animado.gif" />';
    @ViewChild('tabla') tabla : TblCitaReporteDetalladoComponent;
  ...
  maxDate: string = '';
    ...
    ngAfterViewInit(): void {
      this.tabla._collection.subscribe((res: CitaReporteDetallado[]) => {
    ...
    /**
     * Maneja la selección de zona del autocomplete
     */
    onZonaSelected(event: AutocompleteSelectionEvent): void {
      // El FormControl ya se actualiza automáticamente
      // Este método puede ser usado para lógica adicional si es necesaria
