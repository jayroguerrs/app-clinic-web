...
import { ReporteZonasMaximoRoutingModule } from './reportezonasmaximo-routing.module';
...
@NgModule({
    imports: [
        ...
        FormsModule,
        IonicModule,
        ReporteZonasMaximoRoutingModule,
        ChartModule,
        NgbTooltipModule,
        MorrisJsModule,
    ...
    declarations: [ReporteZonasMaximoComponent]
})
export class ZonaMaximoReportesModule { }
