...
import {ReporteClientesNuevosRoutingModule} from "./reporte-clientes-nuevos-routing.module";
import {ReporteClientesNuevosComponent} from "./reporte-clientes-nuevos.component";

@NgModule({
    imports: [CommonModule,
        ReactiveFormsModule,
        ReporteClientesNuevosRoutingModule,
        SharedModule,
        DataTablesModule,
        FormsModule,
        NgbTooltipModule,
    ...
    declarations: [
        ReporteClientesNuevosComponent
    ]

})
export class ReporteClientesNuevosModule {}
