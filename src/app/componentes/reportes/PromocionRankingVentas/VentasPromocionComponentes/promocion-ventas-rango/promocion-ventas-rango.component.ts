...
@Component({
  selector: 'app-promocion-ventas-rango',
  templateUrl: './promocion-ventas-rango.component.html',
  styleUrls: ['./promocion-ventas-rango.component.scss']
})
export class PromocionVentasRangoComponent implements OnInit, AfterViewInit, OnDestroy {
        ...
        buttons: [
          {
            extend: 'excelHtml5',
            title: () => {
              return 'Reporte promoción ranking ventas por sede, promoción: ' + this.promocionSeleccionada + ' - desde ' + this.FechaInicio + ' hasta ' + this.FechaFin;
            },
            exportOptions: {
              columns: [ 1,2,3 ]
            },
  ...
  buildGraph(): void{
    ...
    am4core.ready(() => {
      ...
      setTimeout( () => {
        ...
        this.chart = am4core.create("barchartPromocionVentas", am4charts.XYChart);
  ...
  buildPieGraph(): void{
    ...
    am4core.ready(() => {
      ...
      // Create chart instance
      this.piechart = am4core.create("piechartPromocionVentas", am4charts.PieChart);
