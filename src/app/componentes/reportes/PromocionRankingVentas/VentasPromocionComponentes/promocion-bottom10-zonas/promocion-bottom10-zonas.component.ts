...
import {PromocionZonaRanking, Promocion} from "../../../../../shared/models/promocion";
...
@Component({
  selector: 'app-promocion-bottom10-zonas',
  templateUrl: './promocion-bottom10-zonas.component.html',
  styleUrls: ['./promocion-bottom10-zonas.component.scss']
})
export class PromocionBottom10ZonasComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    if(this.FechaInicio && this.FechaFin) {
      ...
      this.dtResponsiveOptions = {
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.subscription = this.api.obtenerBottom10Zona(this.FechaInicio, this.FechaFin, this.IdSede, 1, this.IdPromocion).subscribe((res) => {
            callback({data: res});
            this.collection = res;
            // console.log(res);
          }, error => {
        ...
        buttons: [
          {
            extend: 'excelHtml5',
            title: () => {
              return 'Reporte top 10 zonas mas agendadas con relación a la promoción:  desde ' + this.FechaInicio + ' hasta ' + this.FechaFin;
            },
            exportOptions: {
              columns: [ 1,2,3 ]
            },
  ...
  buildGraph(): void{
    ...
    am4core.ready(() => {
      ...
      am4core.addLicense("ch-custom-attribution");
        ...
        this.chart = am4core.create("chartBottomGeneral", am4charts.XYChart);
