...
import {MdlCategoriaComponent} from "../../componente/modal/mdl-categoria/mdl-categoria.component";
...
export class CategoriaComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  buildtable(): void{
    this.dtResponsiveOptions = {
      ...
      columns: [
        ...
        { title: 'SERVICIO', data: 'servicio', className: 'text-uppercase' },
      ...
      createdRow:  ( row, data, index ) => {
        ...
        $('td', row).eq(1).addClass('bg-color-secondary');
      },
      serverSide: false,
      processing: false,
      async: true,
  ...
  onCreate(): void{
    const modalRef = this.modalService.open(MdlCategoriaComponent);
