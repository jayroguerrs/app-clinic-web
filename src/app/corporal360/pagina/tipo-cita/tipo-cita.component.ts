...
import {MdlTipoCitaComponent} from "../../componente/modal/mdl-tipo-cita/mdl-tipo-cita.component";
...
export class TipoCitaComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  onCreate(): void{
    const modalRef = this.modalService.open(MdlTipoCitaComponent);
