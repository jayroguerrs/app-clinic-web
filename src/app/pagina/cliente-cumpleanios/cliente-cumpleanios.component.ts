...
@Component({
  selector: 'app-cliente-cumpleanios',
  templateUrl: './cliente-cumpleanios.component.html',
  styleUrls: ['./cliente-cumpleanios.component.scss']
})
export class ClienteCumpleaniosComponent implements OnInit, AfterViewInit, OnDestroy {
