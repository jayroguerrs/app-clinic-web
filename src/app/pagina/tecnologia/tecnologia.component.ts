...
import {MdlServicioComponent} from "../../componentes/modals/mdl-servicio/mdl-servicio.component";
import {TecnologiaService} from "../../shared/services/tecnologia.service";
import {MdlTecnologiaComponent} from "../../componentes/modals/mdl-tecnologia/mdl-tecnologia.component";
...
export class TecnologiaComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  buildtable(): void{
    this.dtResponsiveOptions = {
      ...
      columns: [
        ...
        { title: 'NOMBRE CORTO', data: 'nombreCorto', className: '' },
        { title: 'DESCRIPCIÓN', data: 'descripcion', className: '' },
  ...
  onCreate(): void{
    const modalRef = this.modalService.open(MdlTecnologiaComponent);
