...
export class ServicioComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  buildtable(): void{
    this.dtResponsiveOptions = {
      ...
      columns: [
        ...
        { title: 'COLOR', data: 'color', width: '100px', render: (data: string) => {
          return `<span class="rounded px-4 py-2 d-block" style="background-color:${data};width: 50px"></span>`;
        }},
  ...
  onCreate(): void{
    const modalRef = this.modalService.open(MdlServicioComponent,{backdrop: "static"});
