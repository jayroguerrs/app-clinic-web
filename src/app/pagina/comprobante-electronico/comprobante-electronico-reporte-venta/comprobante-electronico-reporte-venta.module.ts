...
import {ComprobanteElectronicoReporteVentaRoutingModule} from "./comprobante-electronico-reporte-venta-routing.module";
...
@NgModule({
  ...
  imports: [
    CommonModule,
    ComprobanteElectronicoReporteVentaRoutingModule,
    NgbTooltipModule,
    MatRippleModule,
    DataTablesModule,
  ...
  exports: [ComprobanteElectronicoReporteVentaComponent],
  providers: [],
  bootstrap: [ComprobanteElectronicoReporteVentaComponent]
})
export class ComprobanteElectronicoReporteVentaModule { }
