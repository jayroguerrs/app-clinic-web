...
import {ComprobanteElectronicoReporteVentaProductoRoutingModule} from "./comprobante-electronico-reporte-venta-producto-routing.module";

@NgModule({
  declarations: [ComprobanteElectronicoReporteVentaProductoComponent],
  imports: [
    CommonModule,
    ComprobanteElectronicoReporteVentaProductoRoutingModule,
    NgbTooltipModule,
    MatRippleModule,
    DataTablesModule,
  ...
  exports: [ComprobanteElectronicoReporteVentaProductoComponent],
  providers: [],
  bootstrap: [ComprobanteElectronicoReporteVentaProductoComponent]
})
export class ComprobanteElectronicoReporteVentaProductoModule { }
