...
! function() {
    ...
    function b(e, t, o) {
        var n, a;
        if (a = o, n = (n = t) > 0 ? 1 : -1, a = a > 0 ? 1 : -1, (l.x !== n || l.y !== a) && (l.x = n, l.y = a, h = [], p = 0), 1 != r.accelerationMax) {
            var i = Date.now() - p;
            ...
            var u = e === document.body,
                d = function(n) {
                    for (var a = Date.now(), i = 0, l = 0, c = 0; c < h.length; c++) {
                        ...
                        r.pulseAlgorithm && (p = j(p));
                        var b = s.x * p - s.lastX >> 0,
                            v = s.y * p - s.lastY >> 0;
                        i += b, l += v, s.lastX += b, s.lastY += v, m && (h.splice(c, 1), c--)
                    }
                    u ? window.scrollBy(i, l) : (i && (e.scrollLeft += i), l && (e.scrollTop += l)), t || o || (h = []), h.length ? N(d, e, 1e3 / r.frameRate + 1) : w = !1
                };
            N(d, e, 0), w = !0
        }
    }
    ...
    function v(t) {
        ...
        if (s && (t.wheelDeltaX && B(t.wheelDeltaX, 120) && (a = t.wheelDeltaX / Math.abs(t.wheelDeltaX) * -120), t.wheelDeltaY && B(t.wheelDeltaY, 120) && (i = t.wheelDeltaY / Math.abs(t.wheelDeltaY) * -120)), a || i || (i = -t.wheelDelta || 0), 1 === t.deltaMode && (a *= 40, i *= 40), !r.touchpadSupport && function(e) {
                if (!e) return;
                d.length || (d = [e, e, e]);
    ...
    function g(t) {
        ...
        if (/^(textarea|select|embed|object)$/i.test(o.nodeName) || A(o, "input") && !a.test(o.type) || A(e, "video") || function(e) {
                var t = e.target,
                    o = !1;
    ...
    var K, N = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e, t, o) {
    ...
    function j(e) {
        return e >= 1 ? 1 : e <= 0 ? 0 : (1 == r.pulseNormalize && (r.pulseNormalize /= R(1)), R(e))
    }
    ...
    "onwheel" in document.createElement("div") ? F = "wheel" : "onmousewheel" in document.createElement("div") && (F = "mousewheel"), F && W && (X(F, v), X("mousedown", y), X("load", m)), G.destroy = function() {
        t && t.disconnect(), Y(F, v), Y("mousedown", y), Y("keydown", g), Y("resize", o), Y("load", m)
